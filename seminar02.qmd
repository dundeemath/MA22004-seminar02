...
- Thu workshop on Thursday moves venue - see the timetable
- Lab 1 due at end of week 3 (we are in week 2!)
...
Over the next two seminars we will consider these concepts in general (to familiarize ourselves with language, notation, etc). Then we will focus on inferences in specific contexts. 
...
:::: {.columns}
::: {.column width="50%"}
The box contains 100 pieces of candy.
...
5. Return the sample to the box, shake box, pass to next pair.

**Do not weigh the whole box!**
:::
